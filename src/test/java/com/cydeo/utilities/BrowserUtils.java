...
public class BrowserUtils {
    ...
    public static void  switchWindowAndVerify(String expectedInUrl,String expectedTitle){
        ...
        for(String eachWindow:allWindows){
            Driver.getDriver().switchTo().window(eachWindow);  // driver.switchTo().window(eachWindow); ->switch each windows and driver will be able to see each window
